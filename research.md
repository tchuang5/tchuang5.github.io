...
<ol style="counter-reset: list 4">
	...
	<li> &ldquo;Nonparametric tests for treatment effect heterogeneity under Regression Kink design,&rdquo; with Yu-Chin Hsu.</li> 
...
<ol style="counter-reset: list 5">
	<li> Hsu, Yu-Chin, Ta-Cheng Huang, and Haiqing Xu (2023): &ldquo;Testing for unobserved heterogeneous treatment effects with observational data,&rdquo; <em>Econometric Theory</em>,  39(3), pp. 582-622. 
